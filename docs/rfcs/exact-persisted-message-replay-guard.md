...
12. overlapping saves cannot leave a newer sidecar paired with an older sidebar-index projection; and
13. a replay-guard failure leaves live bytes unchanged and cannot authorize restoration of a smaller stale backup.
