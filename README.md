...
- Send key: Enter (default), Ctrl/Cmd+Enter, or Shift+Enter; an optional browser-local override can keep different keyboard behavior on different devices without changing the shared server setting
